...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* Keyco features */
    { "keyco",               "masternode",             &masternode,             true,      true,       false },
    { "keyco",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "keyco",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "keyco",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "keyco",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "keyco",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "keyco",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "keyco",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use keycod, or the -server option to keyco-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> keyco-cli " + methodname + " " + args + "\n";
}
