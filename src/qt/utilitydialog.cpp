    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Keyco Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Keyco Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  keyco-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Keyco Core is shutting down...") + "<br /><br />" +
