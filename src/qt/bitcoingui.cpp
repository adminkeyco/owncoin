    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Keyco Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Keyco address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and keyco: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Keyco Core"), this);
    aboutAction->setStatusTip(tr("Show information about Keyco Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Keyco"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Keyco addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Keyco addresses"));
    ...
    openAction->setStatusTip(tr("Open a keyco: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Keyco Core help message to get a list with possible Keyco command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Keyco Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Keyco network", "", count));
}
...
{
    QString strTitle = tr("Keyco Core"); // default title
