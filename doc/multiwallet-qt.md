...
Only requiring some minor changes is keyco.cpp.
...
Changes to keyco.cpp
----------------------
keyco.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
