...
You need the Qt4 run-time libraries to run Keyco-Qt. On Debian or Ubuntu:
...
* Ask for help on the [KeycoTalk](https://keycotalk.org/) forums.
...
Development
---------------------
The Keyco repo's [root README](https://github.com/adminkeyco/wallet/blob/master/README.md) contains relevant information on the development process and automated testing.
...
### Resources
* Discuss on the [KeycoTalk](https://keycotalk.org/) forums, in the Development & Technical Discussion board.
